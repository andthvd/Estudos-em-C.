   	...
   	switch (opcao)
	   {
			...
			case 4:{
				...
				printf ("**********************************************************************");
	   			...
	   			Sleep(800);
	   			//COMO O CALCULO DA OPCAO TRABALHAR ESTAVA FREQUENTEMENTE FAZENDO O UNIZINHO PERDER O JOGO, TOMEI A LIBERDADE DE DIMINUIR OS CUSTOS DESSA AÇÃO EM UMA UNIDADE CADA
	   			energia=(energia-4);
	   			alimento=(alimento-4);
	   			descanso=(descanso-4);
	   			aprendizado=(aprendizado-2);
